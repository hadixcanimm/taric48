...
Taric Theme: Instead of numbers, there are Taric’s skins (you can switch back to numbers if you want).

Portable: You can drag the window anywhere you like within the client.
